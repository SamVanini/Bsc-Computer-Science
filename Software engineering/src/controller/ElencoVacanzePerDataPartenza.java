...
public class ElencoVacanzePerDataPartenza {
    ...
    @FXML
    public TableView<Vacanze> TableDataPartenza;
    @FXML
    ...
    public void cerca(ActionEvent actionEvent) {
        if (DataP.getText().isBlank()) {
            ...
            Elenco = VacanzeDAO.selectVacanzeDataPartenza(DataP.getText());
            TableDataPartenza.setItems(Elenco);
        }
    }
}
