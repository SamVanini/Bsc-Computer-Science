...
public interface HaveFunVisitor<T> extends ParseTreeVisitor<T> {
	 ...
	 * @return the visitor result
	 */
	T visitGlobalDecl(HaveFunParser.GlobalDeclContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitGlobalAssign(HaveFunParser.GlobalAssignContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitNd(HaveFunParser.NdContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitGlobalID(HaveFunParser.GlobalIDContext ctx);
	/**
